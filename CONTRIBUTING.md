...
- Create a [new issue](https://github.com/PlotiHub/plotihub/issues)
- Comment on the issue (if you'd like to be assigned to it) - that way the issue can be assigned to you.

### Open issues

- Go to [open issues](https://github.com/PlotiHub/plotihub/issues)
...
```
$ git remote add upstream git@github.com:PlotiHub/plotihub.git
```
